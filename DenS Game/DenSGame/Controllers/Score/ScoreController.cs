...
namespace DenSGame.Controllers.Score
{
    public class ScoreController : DenSGameController<DenSGameContext>
    {
        public JsonResult GetScores()
        {
            var users = _dataContext.Users
                .Where(a_item => !a_item.IsDennis && !a_item.IsSandra && !a_item.IsRoot)
                .ToList();
