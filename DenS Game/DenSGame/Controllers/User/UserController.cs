...
namespace DenSGame.Controllers.User
{
    public class UserController : DenSGameController<DenSGameContext>
    {
        public const string CoockieName = "DenSGame_UserID";
        ...
        public static Data.Models.User GetUserObject(HttpRequestBase request)
        {
            ...
            var userID = long.Parse(coockie.Value);
            using (var dataContext = new DenSGameContext())
            {
